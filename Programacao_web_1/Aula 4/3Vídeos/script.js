...
function inicializar() {
    itens = JSON.parse(localStorage.getItem('itens1') || '[]');
    exibirItens();
    console.log(itens)
}
...
function AddItem() {
    ...
    localStorage.setItem('itens1', JSON.stringify(itens));
    exibirItens()
